/* CampusCarbon — Plant & Tree Scanner backend (Cloudflare Pages Function)
   Lives at /api/plant-scan
   Runs on Cloudflare's edge, never in the browser, so the API key stays secret.
   Requires GEMINI_API_KEY set in: Cloudflare dashboard > your Pages project >
